...
import static com.dremio.oauth2.agent.config.TokenRefreshConfig.ACCESS_TOKEN_LIFESPAN;
import static com.dremio.oauth2.agent.config.TokenRefreshConfig.IDLE_TIMEOUT;
import static com.dremio.oauth2.agent.config.TokenRefreshConfig.PREFIX;
import static com.dremio.oauth2.agent.config.TokenRefreshConfig.SAFETY_WINDOW;
