...
import static com.dremio.oauth2.agent.config.BasicConfig.CLIENT_AUTH;
import static com.dremio.oauth2.agent.config.JwtClientAuthConfig.ALGORITHM;
import static com.dremio.oauth2.agent.config.JwtClientAuthConfig.PRIVATE_KEY;
import static com.dremio.oauth2.agent.config.ResourceOwnerConfig.PASSWORD;
import static com.dremio.oauth2.agent.config.ResourceOwnerConfig.USERNAME;
