...
import static com.dremio.oauth2.agent.TestConstants.CLIENT_ID1;
import static com.dremio.oauth2.agent.TestConstants.CLIENT_ID2;
import static com.dremio.oauth2.agent.TestConstants.SCOPE1;
import static com.dremio.oauth2.agent.TestConstants.SCOPE2;
import static com.dremio.oauth2.agent.expectation.ErrorExpectation.AUTHORIZATION_SERVER_ERROR_RESPONSE;
...
public abstract class AuthorizationCodeExpectation extends InitialTokenFetchExpectation {
  ...
  @Value.Lazy
  protected ConcurrentMap<String, PendingAuthRequest> getPendingAuthRequests() {
