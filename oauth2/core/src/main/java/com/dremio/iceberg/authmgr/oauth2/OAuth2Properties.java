...
public final class OAuth2Properties {
  ...
  public static final class Basic {
     ...
     *
     * <ul>
     *   <li>{@link GrantType#CLIENT_CREDENTIALS}
     *   <li>{@link GrantType#PASSWORD}
     *   <li>{@link GrantType#AUTHORIZATION_CODE}
     *   <li>{@link GrantType#DEVICE_CODE}
     *   <li>{@link GrantType#TOKEN_EXCHANGE}
     * </ul>
     *
     * Optional, defaults to {@link GrantType#CLIENT_CREDENTIALS}.
     */
  ...
  public static final class System {
     ...
     *
     * <ul>
     *   <li>{@code DEFAULT}: uses the default HTTP client provided by the underlying OAuth2
     *       library.
     * </ul>
     *
