...
public interface SystemConfig {
  ...
  default SystemConfig merge(Map<String, String> properties) {
    ...
    builder.sessionCacheTimeoutOption().set(properties);
    builder.httpClientTypeOption().set(properties);
  ...
  interface Builder {
    ...
    private ConfigOption<HttpClientType> httpClientTypeOption() {
      return ConfigOptions.simple(HTTP_CLIENT_TYPE, this::httpClientType, HttpClientType::valueOf);
    }
  }
}
