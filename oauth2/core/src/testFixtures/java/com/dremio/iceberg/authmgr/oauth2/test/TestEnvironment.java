...
public abstract class TestEnvironment implements AutoCloseable {
  ...
  public HttpClient getHttpClient() {
    return getSystemConfig().getHttpClientType().newHttpClient();
  }
  ...
  public EndpointProvider getEndpointProvider() {
    return EndpointProvider.of(getAgentSpec(), getHttpClient());
  }
  ...
  @Value.Default
  public OAuth2Config getAgentSpec() {
  ...
  public BasicConfig getBasicConfig() {
    ...
    getClientAuthenticationMethod().ifPresent(builder::clientAuthenticationMethod);
  ...
  public abstract Optional<ClientAuthenticationMethod> getClientAuthenticationMethod();
  ...
  public Map<String, String> getSubjectTokenConfig() {
    ImmutableMap.Builder<String, String> builder =
        ImmutableMap.<String, String>builder()
            ...
            .put(Basic.CLIENT_SECRET, getSubjectClientSecret().getValue())
  ...
  public Map<String, String> getActorTokenConfig() {
    ImmutableMap.Builder<String, String> builder =
        ImmutableMap.<String, String>builder()
            ...
            .put(Basic.CLIENT_SECRET, getActorClientSecret().getValue())
            .put(Basic.EXTRA_PARAMS_PREFIX + "extra2", "value2")
  ...
  public FlowFactory newFlowFactory() {
    return FlowFactory.of(getAgentSpec(), getExecutor(), getHttpClient());
  }
