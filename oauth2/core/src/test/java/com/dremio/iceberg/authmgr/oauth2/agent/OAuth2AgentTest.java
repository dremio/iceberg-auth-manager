...
class OAuth2AgentTest {
  ...
  void testClientCredentials(boolean returnRefreshTokens) {
  ...
  @CsvSource({
    ...
    "true,  true,  urn:ietf:params:oauth:grant-type:device_code",
    "true,  false, urn:ietf:params:oauth:grant-type:device_code",
    "false, true,  urn:ietf:params:oauth:grant-type:device_code",
    "false, false, urn:ietf:params:oauth:grant-type:device_code",
  })
  void testTokenExchangeDynamicSubject(
      boolean privateClient, boolean returnRefreshTokens, GrantType subjectGrantType)
      throws InterruptedException, ExecutionException {
    try (TestEnvironment env =
            TestEnvironment.builder()
                .grantType(GrantType.TOKEN_EXCHANGE)
  ...
  void testTokenExchangeDynamicActor(
      boolean privateClient, boolean returnRefreshTokens, GrantType actorGrantType)
      throws InterruptedException, ExecutionException {
    try (TestEnvironment env =
            TestEnvironment.builder()
                .grantType(GrantType.TOKEN_EXCHANGE)
