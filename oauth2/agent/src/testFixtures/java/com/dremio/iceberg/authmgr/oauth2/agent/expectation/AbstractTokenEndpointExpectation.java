...
import static com.dremio.iceberg.authmgr.oauth2.agent.TestConstants.CLIENT_ID1;
import static com.dremio.iceberg.authmgr.oauth2.agent.TestConstants.CLIENT_ID2;
import static com.dremio.iceberg.authmgr.oauth2.agent.TestConstants.CLIENT_SECRET1;
import static com.dremio.iceberg.authmgr.oauth2.agent.TestConstants.CLIENT_SECRET2;
...
public abstract class AbstractTokenEndpointExpectation extends AbstractExpectation {
  ...
  protected HttpRequest request() {
    ...
    return HttpRequest.request()
        ...
        .withBody(getParameterBody(requestBody().build()));
  }
