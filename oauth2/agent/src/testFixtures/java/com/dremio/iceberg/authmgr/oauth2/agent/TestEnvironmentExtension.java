...
public abstract class TestEnvironmentExtension implements ParameterResolver {
  ...
  public boolean supportsParameter(
    ...
    return parameterContext.getParameter().getType().equals(Builder.class);
  }
  ...
  public Object resolveParameter(
      ParameterContext parameterContext, ExtensionContext extensionContext)
      throws ParameterResolutionException {
    if (parameterContext.getParameter().getType().equals(Builder.class)) {
      return newTestEnvironmentBuilder(extensionContext);
    }
    throw new ParameterResolutionException("Unsupported parameter type");
  }

  protected abstract Builder newTestEnvironmentBuilder(ExtensionContext extensionContext);
}
