 ...
 */
package com.dremio.iceberg.authmgr.oauth2.agent.flow;
...
import com.dremio.iceberg.authmgr.oauth2.agent.endpoint.EndpointProvider;
import com.dremio.iceberg.authmgr.oauth2.agent.http.HttpClient;
import com.dremio.iceberg.authmgr.oauth2.agent.jwtbearer.AssertionSupplier;
import com.dremio.iceberg.authmgr.oauth2.agent.tokenexchange.ActorTokenSupplier;
import com.dremio.iceberg.authmgr.oauth2.agent.tokenexchange.SubjectTokenSupplier;
...
public abstract class FlowFactory implements AutoCloseable {
  ...
  public static FlowFactory create(OAuth2AgentConfig config, OAuth2AgentRuntime runtime) {
  ...
  protected abstract OAuth2AgentConfig getConfig();
