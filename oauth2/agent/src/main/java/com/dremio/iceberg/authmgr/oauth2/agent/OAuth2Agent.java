...
import static com.dremio.iceberg.authmgr.oauth2.agent.concurrent.AutoCloseables.cancelOnClose;

import com.dremio.iceberg.authmgr.oauth2.agent.concurrent.Futures;
import com.dremio.iceberg.authmgr.oauth2.agent.config.ConfigUtils;
import com.dremio.iceberg.authmgr.oauth2.agent.dpop.DpopContext;
import com.dremio.iceberg.authmgr.oauth2.agent.dpop.DpopScope;
import com.dremio.iceberg.authmgr.oauth2.agent.flow.Flow;
...
public final class OAuth2Agent implements Closeable {
  ...
  private final OAuth2AgentConfig config;
  ...
  public OAuth2Agent(OAuth2AgentConfig config, OAuth2AgentRuntime runtime) {
    this.config = config;
  ...
  public OAuth2AgentConfig getConfig() {
    return config;
  }
