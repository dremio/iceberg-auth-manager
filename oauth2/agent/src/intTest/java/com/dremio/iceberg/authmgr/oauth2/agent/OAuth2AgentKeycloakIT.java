...
import static com.dremio.iceberg.authmgr.oauth2.agent.junit.KeycloakExtension.CLIENT_ID1;
import static com.dremio.iceberg.authmgr.oauth2.agent.junit.KeycloakExtension.CLIENT_ID2;
import static com.dremio.iceberg.authmgr.oauth2.agent.junit.KeycloakExtension.CLIENT_ID3;
import static com.dremio.iceberg.authmgr.oauth2.agent.junit.KeycloakExtension.CLIENT_ID4;
import static com.dremio.iceberg.authmgr.oauth2.agent.junit.KeycloakExtension.CLIENT_ID5;
import static com.dremio.iceberg.authmgr.oauth2.agent.junit.KeycloakExtension.CLIENT_ID6;
import static com.dremio.iceberg.authmgr.oauth2.agent.junit.KeycloakExtension.CLIENT_SECRET3;
import static com.dremio.iceberg.authmgr.oauth2.agent.junit.KeycloakExtension.CLIENT_SECRET6;
import static com.dremio.iceberg.authmgr.oauth2.agent.junit.KeycloakExtension.JWT_BEARER_ECDSA_ASSERTION_ISSUER;
import static com.dremio.iceberg.authmgr.oauth2.agent.junit.KeycloakExtension.SCOPE1;
import static com.dremio.iceberg.authmgr.oauth2.agent.junit.KeycloakExtension.createJwtBearerAssertion;
...
import com.dremio.iceberg.authmgr.oauth2.agent.flow.OAuth2Exception;
...
import com.dremio.iceberg.authmgr.oauth2.agent.junit.KeycloakExtension;
...
public class OAuth2AgentKeycloakIT {
  ...
  @CartesianTest
  void httpsCallback(
      @EnumLike CodeChallengeMethod method, ImmutableTestEnvironment.Builder envBuilder)
      throws Exception {
    TestCertificates certs = TestCertificates.instance();
  ...
  @Test
  void jwtBearerEcdsa(ImmutableTestEnvironment.Builder envBuilder, KeycloakContainer keycloak)
      throws Exception {
    TestCertificates certs = TestCertificates.instance();
    String assertion =
  ...
  @Test
  void agentCopy(ImmutableTestEnvironment.Builder envBuilder) throws Exception {
    try (TestEnvironment env = envBuilder.build();
        OAuth2Agent agent = env.newAgent()) {
      try (OAuth2Agent agent2 = agent.copy()) {
