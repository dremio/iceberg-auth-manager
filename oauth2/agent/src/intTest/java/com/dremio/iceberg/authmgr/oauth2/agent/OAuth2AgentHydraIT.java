...
import static com.dremio.iceberg.authmgr.oauth2.agent.junit.HydraExtension.CLIENT_ID1;
import static com.dremio.iceberg.authmgr.oauth2.agent.junit.HydraExtension.CLIENT_ID2;
import static com.dremio.iceberg.authmgr.oauth2.agent.junit.HydraExtension.CLIENT_SECRET1;
import static com.dremio.iceberg.authmgr.oauth2.agent.junit.HydraExtension.CLIENT_SECRET2;
...
import com.dremio.iceberg.authmgr.oauth2.agent.junit.HydraExtension;
...
public class OAuth2AgentHydraIT {
  ...
  void clientSecretBasic(
      @Enum HttpClientType httpClientType, ImmutableTestEnvironment.Builder envBuilder)
      throws Exception {
